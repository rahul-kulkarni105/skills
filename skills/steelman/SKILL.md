---
name: steelman
description: Build the strongest version of an opposing view or rejected option. Use when the user has dismissed an alternative and you want to test that dismissal honestly. Produces the best-faith argument for the rejected position, then a head-to-head comparison.
