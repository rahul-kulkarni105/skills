---
description: Imagine the project shipped and failed; explain why. Produces a vivid post-mortem dated in the future, working backwards from failure to root causes.
agent: ask
argument-hint: Describe the plan or launch to pre-mortem
---
