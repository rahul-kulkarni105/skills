...
description: Coding standards and quality rules for all code files in this project.
applyTo: "**/*.{ts,tsx,js,jsx,mts,mjs,cjs,py,go,rs,java,kt,swift,c,cpp,cs,rb,php}"
---
...
- No string concatenation into SQL, shell, or HTML. No `eval`. Validate
  redirects.
- See secrets-and-safety rules in AGENTS.md for secret handling.
